...
The data is an excel type of structure called a data frame. there are 30 observations on three seprate variables, namely weight, pushups and position, weight and pushups are numerical variables, while position is a categorical varible with values. SKILL or LINE.
# Methods
...
we will get a numerical summary of our data with summary command to see on average how many pushups were done in the various play groups.
